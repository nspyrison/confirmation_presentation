...
.pull-right[
- On 2D monitors: 3D visuals generally have improved perception accuracy, though lower manipulation speed *Lee 1986, Wickens 1994, Tory 2006, counterexample: sedlmair 2013*

- Immersive 3D and static projections report similar perceptive gains, lower manipulation speed, and less comfort *Gracia 2016, Wagner 2018, Nelson 1998*

- With the improved quality, increasing audience, and reduced cost of modern VR, its timely to research dynamic projections in VR 
]
...
.pull-left[
- Visual variant of statistical p-test, pick the real data against data generated from the null hypothesis
- quantative comparison across display type
```{r, out.width='80%', out.height='80%'}
