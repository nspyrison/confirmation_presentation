...
**Research objectives:**
- 1) Can user controlled steering (UCS) be utilized in an environment providing non-interactive animation?
- 2) What benefits does UCS provide over popular alternatives?
- 3) How do we extend UCS to 3D?
- 4) Does UCS with 3D displays provide perception benefits over 2D displays?

---

# 1) 2D User controlled steering

**RO #1) Can user controlled steering (UCS) be utilized in an environment providing non-interactive animation?**
...
# 4) Low-dimension embeddings across display type

**RO #4) Does UCS with 3D displays provide perception benefits over 2D displays?**
